...
#
#   powershell -ExecutionPolicy Bypass -File "$env:USERPROFILE\Documents\video-pipeline\Open-Studio.ps1"
#
# Or after git pull, from wrong folder:
#   & "$env:USERPROFILE\Documents\video-pipeline\Open-Studio.ps1"
...
if (-not (Test-Path (Join-Path $Root "pyproject.toml"))) {
    ...
    Write-Host "  $env:USERPROFILE\Documents\video-pipeline" -ForegroundColor Yellow
    exit 1
}
