...
git checkout origin/cursor/fix-launcher-update-start-977b -- installer/VideoPipelineLauncher.ps1 run-backend.ps1 scripts/stop-backend.ps1 stop-backend.cmd 2>nul
if errorlevel 1 (
