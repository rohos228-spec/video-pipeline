...
STEP_HUMAN_NAMES: dict[str, str] = {
    ...
    "enrich_1":   "5. Доп работа с EXCEL #1",
    "enrich_2":   "6. Доп работа с EXCEL #2",
    "enrich_3":   "7. Доп работа с EXCEL #3",
    "enrich_4":   "8. Доп работа с EXCEL #4",
    "enrich_5":   "9. Доп работа с EXCEL #5",
