...
async def run(session: AsyncSession, project: Project, bot: Bot) -> None:
    ...
    hero_ask = (
        ...
        + "ОДИН описательный промт для генерации эталонного референс-изображения "
        + "главного героя-кота. Только описание внешности, позы и атмосферы; "
        + "без указаний на конкретную сцену. Формат 9:16.\n\n"
    ...
    async with browser_session() as bs:
        ...
        result = await outsee.generate_image(hero_prompt, out_path, aspect_ratio="9:16")
