    ...
    if need_shots:
        ...
        await _run_four_node_markup_pass(
            ...
            accompanying=(
                ...
                "Раскрой shots: роль и план из таблицы, текст действия — "
                "полное описание кадра (помещение, кто, одежда, эмоция, "
                "поступок), не слоган «понял / испугался / решил». "
            ...
            if scene_grammar:
                ...
                if script_writer:
                    ...
                    accompanying = (
                        ...
                        "действие — полное описание кадра (помещение, кто, "
