...
_SCENE_GRAMMAR_APPLY_HINT = (
    "# SCENE GRAMMAR — ЗАПИСЬ (v1.5, СЦЕНА = SoT + film-pack)\n"
    "Верни JSON {characters, scenes, ops, report}. "
    "Структура/план/переход — по таблицам «когда/что/нельзя» в master. "
    "особенность_сцены — только словарь крупностей. "
    "акцент сцены и каждого shot — уникальный конкретный объект/жест. "
    "ops=[]. Запрет: клон акцента; 1 колонка=1 сцена; TSV; error про объём.\n"
)
