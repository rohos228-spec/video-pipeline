...
## Назначение
Структурированная версия legacy-промта ноды `enrich_2` без потери исходных данных.

## Активный шаблон
`prompts/steps/05b_enrich_2/template.md`

## Пресет
`default` в `prompts/step-presets/enrich_2.json`
...
```md
# Доп. работа с Excel #2

## 1. ТЕХНИЧЕСКАЯ ЧАСТЬ
- Откуда читаю: приложенный `project.xlsx` в его текущем состоянии, лист «{{VAR:ENRICH_2_SHEET}}».
