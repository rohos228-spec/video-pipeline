...
# Reworked: заполнение таблицы.md → Blocks v2
...
## Пресет
`zapolnenie_tablicy` в `prompts/step-presets/enrich_1.json`

## Полный исходник
`prompts/blocks/enrich_source_full/zapolnenie_tablicy_full.md`
