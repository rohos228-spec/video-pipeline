...
Нода: `enrich_3`
Активный шаблон: `prompts/steps/05c_enrich_3/template.md`
Blueprint: `prompts/05c_enrich_3/_universal_enrich_3_prompt_blueprint.md`
Пресеты UI/API: `prompts/step-presets/enrich_3.json`
