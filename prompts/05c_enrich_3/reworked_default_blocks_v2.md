...
## Назначение
Структурированная версия legacy-промта ноды `enrich_3` без потери исходных данных.

## Активный шаблон
`prompts/steps/05c_enrich_3/template.md`

## Пресет
`default` в `prompts/step-presets/enrich_3.json`
