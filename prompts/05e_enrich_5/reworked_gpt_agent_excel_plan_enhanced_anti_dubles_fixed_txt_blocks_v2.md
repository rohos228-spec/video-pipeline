...
# Reworked: GPT_Agent_Excel_Plan_Enhanced_ANTI_DUBLES_FIXED.txt.md → Blocks v2
...
## Пресет
`gpt_agent_excel_plan_enhanced_anti_dubles_fixed_txt` в `prompts/step-presets/enrich_5.json`

## Полный исходник
`prompts/blocks/enrich_source_full/gpt_agent_excel_plan_enhanced_anti_dubles_fixed_txt_full.md`
