...
## Назначение
Структурированная версия legacy-промта ноды `enrich_4` без потери исходных данных.

## Активный шаблон
`prompts/steps/05d_enrich_4/template.md`

## Пресет
`default` в `prompts/step-presets/enrich_4.json`
