...
не перекрывали новые. Место кадра — место паспорта с уточнением
(«дом: коридор»); поле «Место» сцены показывает общий корень («дом»),
если все кадры — уточнения одного места.

Якоря сцены на доске (`scene_anchor_bits`) — все якоря, чей текст лежит
в закадре этой сцены: с родителя, с шотов сцены и осиротевшие с чужих
родителей (старые склейки / разделения). Свой якорь без текста виден
красным, если его текста нет и в других сценах. Склейка, разделение и
сохранение якорей переносят биты на родителя нужной сцены
(`claim_scene_bits`). Под якорем на доске — только сам якорь.
