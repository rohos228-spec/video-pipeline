...
export const PLAN_CELLS: ExcelCellDef[] = [
  ...
  // v8 template «план»: R7=фон, R8=персонажи (не путать с устаревшей разметкой).
  { id: "plan:r7", sheetId: "plan", row: 7, label: "фон", address: "R7", group: "shot_01" },
  { id: "plan:r8", sheetId: "plan", row: 8, label: "персонажи", address: "R8", group: "shot_01" },
  { id: "plan:r9", sheetId: "plan", row: 9, label: "предметы", address: "R9", group: "shot_01" },
  { id: "plan:r10", sheetId: "plan", row: 10, label: "действие", address: "R10", group: "shot_01" },
  { id: "plan:r11", sheetId: "plan", row: 11, label: "описание кадра", address: "R11", group: "shot_01" },
  { id: "plan:r12", sheetId: "plan", row: 12, label: "логика перехода", address: "R12", group: "shot_01" },
  { id: "plan:r13", sheetId: "plan", row: 13, label: "заметки по консистенции", address: "R13", group: "shot_01" },
  { id: "plan:r14", sheetId: "plan", row: 14, label: "статус", address: "R14", group: "shot_01" },
  { id: "plan:r16", sheetId: "plan", row: 16, label: "кадр2", address: "R16", group: "shot_02" },
  { id: "plan:r17", sheetId: "plan", row: 17, label: "id scene", address: "R17", group: "shot_02" },
  { id: "plan:r22", sheetId: "plan", row: 22, label: "фон", address: "R22", group: "shot_02" },
  { id: "plan:r23", sheetId: "plan", row: 23, label: "персонажи", address: "R23", group: "shot_02" },
  { id: "plan:r24", sheetId: "plan", row: 24, label: "предметы", address: "R24", group: "shot_02" },
  { id: "plan:r26", sheetId: "plan", row: 26, label: "описание кадра", address: "R26", group: "shot_02" },
  { id: "plan:r28", sheetId: "plan", row: 28, label: "заметки по консистенции", address: "R28", group: "shot_02" },
...
const BLOCK_CELL_MAP: Record<string, string[]> = {
  ...
  role_hero_designer: ["chars:r3", "chars:r4", "chars:r5", "chars:r6", "plan:r8"],
  ...
  feat_anthro_cats: ["general:heroes", "plan:r8", "chars:r4"],
