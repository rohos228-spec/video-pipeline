---
name: noir-bloody-image-prompt
description: >-
  Собирает image PROMPT+NEGATIVE в стиле Noir Graphic Novel True-Crime Thriller Poster. Use when: нуар, true-crime, кровавый постер, graphic novel crime, грязный темный кровавый, investigation noir.
---

# Noir bloody true-crime image prompt
...
- **Суть:** noir graphic novel + gritty crime thriller poster, heavy black shadows, dirty cream, blood-red accents, rough print, one unified scene (no collage/panels).
