# Style spec: Noir Graphic Novel True-Crime Thriller Poster
...
СТИЛЬ: Noir Graphic Novel True-Crime Thriller Poster

Назначение:
Шаблон фиксирует только стиль исходного промта. Не фиксировать детектива, переулок, дождь, лестницу, дверь или стену расследования. Все сюжетные элементы — переменные.

Краткое описание стиля:
Noir graphic novel, gritty crime thriller poster style, heavy black shadows, rough printed texture, wet noir atmosphere, dirty cream highlights, blood-red accents, high contrast and dramatic true-crime visual storytelling.
...
NEGATIVE PROMPT:
text, words, letters, numbers, title card, captions, subtitles, readable documents, logos, watermark, collage, separate comic panels, bright colors, clean vector art, cute style, photorealism, low detail, blurry, extra detectives, gore, [CONTEXT_SPECIFIC_NEGATIVES]
